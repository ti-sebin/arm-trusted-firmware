...
static inline uint32_t lpddr4_intr_ctlint_sf(const lpddr4_privatedata *pd, const lpddr4_intr_ctlinterrupt intr, const bool *irqstatus)
{
	uint32_t ret = 0;
...
static inline uint32_t lpddr4_intr_ack_ctlint_sf(const lpddr4_privatedata *pd, const lpddr4_intr_ctlinterrupt intr)
{
	uint32_t ret = 0;
...
static inline uint32_t lpddr4_intr_phyint_sf(const lpddr4_privatedata *pd, const lpddr4_intr_phyindepinterrupt intr, const bool *irqstatus)
{
	uint32_t ret = 0;
...
static inline uint32_t lpddr4_intr_ack_phyint_sf(const lpddr4_privatedata *pd, const lpddr4_intr_phyindepinterrupt intr)
{
	uint32_t ret = 0;
